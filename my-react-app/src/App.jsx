  ...
  return (
    <div className="cursor-none relative min-h-screen overflow-hidden bg-[#A7B4CF] text-black font-['Inter']">
      ...
      <section className="relative min-h-screen overflow-hidden px-6 pt-32">
        ...
        {/* FLOATING IMAGES (Using lower file-size thumbnails) */}
      ...
      {/* ABOUT */}
      <section id="about" className="relative z-10 px-6 py-40 border-t border-black/20">
      ...
      {/* WORKS */}
      <section id="works" className="relative z-10 px-6 py-40 border-t border-black/20">
        ...
        <div className="space-y-40">
          {projects.map((project, index) => (
            <article key={project.id} className="grid lg:grid-cols-2 gap-16 items-center">
              <div className={['overflow-hidden', index % 2 === 1 ? 'lg:order-2' : ''].join(' ')}>
                
                {/* FULL SIZE IMAGES (Using full quality files with lazy loading) */}
                <img
              ...
              <div className="space-y-8">
                <p className="uppercase tracking-[0.3em] text-xs">{project.category} / {project.year}</p>
                <h3 className="font-['Anton'] text-[6vw] leading-[0.9] uppercase tracking-tight">{project.title}</h3>
                <div className="flex flex-wrap gap-3 pt-6">
                  <span className="border border-black px-4 py-2 text-xs uppercase tracking-widest">Contextual</span>
                  <span className="border border-black px-4 py-2 text-xs uppercase tracking-widest">Experimental</span>
                  <span className="border border-black px-4 py-2 text-xs uppercase tracking-widest">Spatial</span>
                </div>
              </div>
            </article>
          ))}
      ...
      {/* CONTACT */}
      <section id="contact" className="relative z-10 px-6 pt-40 pb-20 border-t border-black/20">
